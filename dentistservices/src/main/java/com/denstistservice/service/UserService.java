...
import com.denstistservice.dao.UserDao;
...
public class UserService {
    ...
    public void initRolesAndUser() {
        ...
        adminUser.setUserPassword(getEncodePassword("admin@pass"));
      ...
      /*  User user = new User();
        user.setUserFirstName("Ali");
        user.setUserLastName("Ali");
        user.setUserName("ali123");
        user.setUserPassword(getEncodePassword("admin@pass"));
